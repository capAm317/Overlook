      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 col-lg-offset-4 col-md-offset-4 col-sm-offset-4">
          <div class="box auto-box">
            ...
            <div class="info">
              <form role="form" class="form-horizontal myForm" action="loginProcess.php" method="POST">
                <div class="form-group">
                  <label for="#iduser" class="control-label login-label col-lg-2 col-md-2 col-sm-2 col-xs-12">Username:</label>
                  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                    <input type="text" class="form-control" value id="iduser" name="cmsuser" required="true">
                  </div>
                </div>

                <div class="form-group">
                  <label for="#idpass" class="control-label login-label col-lg-2 col-md-2 col-sm-2 col-xs-12">Password</label>
                  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                    <input type="password" class="form-control" value id="idpass" name="cmspass" required="true">
                  </div>
                </div>
