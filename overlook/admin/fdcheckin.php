              ...
              <form class="form-inline" id="checkinidForm">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-addon form-submit" id="searchBtn" onclick="javascript:$('#bookingidForm').submit();"><span class="glyphicon glyphicon-search"></div>
                  </div>
                </div>
              </form>
              ...
              <div class="table-responsive">
                <table class="table">
                  <thead>
                    ...
                    <th class="col-lg-2 col-md-2 col-sm-2 col-xs-2">Check-In Date</th>
                  ...
                  <tbody id="guests">
                    <tr id="guestRow">
                      ...
                      <td>1</td>
                      <td>07/25/2015</td>
                      <td><button type="button" class="btn btn-success"><span class="fa fa-check"></span></button>
                      <td><button type="button" class="btn btn-danger"><span class="fa fa-close"></span></button>
                      -->
